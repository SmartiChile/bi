...
$this->registerMetaTag(['property' => 'og:url', 'content' => Yii::$app->params['domainName'].$idioma->abreviacion.'/site/infoprensa/'.$model->pk]);
		...
		<div class="info-n">
			...
			<div class="contenedor-compartir-noticias">
				...
				<div class="cada-red-compartir" id="margen-compartir-tw">
					<a href="https://twitter.com/share" class="twitter-share-button" data-url="<?= Yii::$app->params['domainName'].$idioma->abreviacion.'/site/infoprensa/'.$model->pk ?>" data-via="somositalia"  data-lang="<?= ($idioma->abreviacion == 'EN' || $idioma->abreviacion == 'en') ? 'en' : 'es' ?>" data-hashtags="barrioitalia">Twittear</a>
