			...
			<div class="info-tienda">
				...
				<div class="contenedor-compartir-tienda">
					<div class="cada-red-compartir">
						<div class="fb-share-button" data-href="<?= Yii::$app->params['domainName'].'site/tienda?t='.$model->pk ?>" data-layout="button_count"></div>
					</div>
					<div class="cada-red-compartir">
						<a href="https://twitter.com/share" class="twitter-share-button" data-url="<?= Yii::$app->params['domainName'].'site/tienda?t='.$model->pk ?>" data-via="somositalia" data-lang="es" data-hashtags="barrioitalia">Twittear</a>
