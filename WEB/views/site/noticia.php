		...
		<div class="info-n">
			...
			<div class="contenedor-compartir-noticias">
				...
				<div class="cada-red-compartir" id="margen-compartir-tw">
					<a href="https://twitter.com/share" class="twitter-share-button" data-url="<?= Yii::$app->params['domainName'].'site/noticia?n='.$model->pk ?>" data-via="somositalia" data-lang="es" data-hashtags="barrioitalia">Twittear</a>
