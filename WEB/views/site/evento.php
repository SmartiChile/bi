...
<div class="contenedor-n">
	...
	<div class="contenido-n">
		...
		<div class="info-n">
			...
			<h5><i class="glyphicon glyphicon-calendar"></i> Inicio: <?php echo Yii::$app->formatter->asDatetime($model->inicio, "php:d-m-Y H:i:s"); ?> | Termino: <?php echo Yii::$app->formatter->asDatetime($model->fin, "php:d-m-Y H:i:s") ?></h5>
			...
			<div class="contenedor-compartir-noticias">
				...
				<div class="cada-red-compartir" id="margen-compartir-tw">
					<a href="https://twitter.com/share" class="twitter-share-button" data-url="<?= Yii::$app->params['domainName'].'site/evento?e='.$model->pk ?>" data-via="somositalia" data-lang="es" data-hashtags="barrioitalia">Twittear</a>
