...
$this->registerMetaTag(['property' => 'og:url', 'content' => Yii::$app->params['domainName'].$idioma->abreviacion.'/site/imagen/'.$model->pk]);
...
<div class="contenedor-vitrina">
	...
	<div id="imagen_part">
		...
		<div id="imagen-top-titulo">
			<p><?= $model->titulo ?></p>
			<div id="social-imagen"><?php echo Html::a(Html::img(Yii::$app->request->baseUrl.'/images/ico-face-vitrina.png'), 'http://www.facebook.com/sharer.php?u='.Yii::$app->params['domainName'].$idioma->abreviacion.'/site/imagen/'.$model->pk, $options = ["onclick"=>"goclicky(this); return false;", 'target'=>'_blank']); ?></div>
		</div>
	</div>
</div>